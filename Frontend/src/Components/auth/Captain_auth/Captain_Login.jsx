...
const CaptainLoginPage = () => {
    const {
        ...
        showPassword,
        setShowPassword,
        isLoading // Assuming this exists in your AuthContext
    } = useAuth();
    ...
    return (
        <div className="min-h-screen drop-shadow-2xl backdrop-blur-3xl  flex items-center justify-center p-4 mt-10">
                    ...
                    <form onSubmit={handleCaptainLogin} className="space-y-4">
                        <div>
                            <input
                                ...
                                placeholder="Email"
                                required
                                className="w-full px-4 py-2.5 border border-gray-100  rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {[Github, Twitter, Facebook].map((Icon, index) => (
                                <button
                                    key={index}
                                    type="button"
                                    className="p-2 border border-gray-100  rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center"
