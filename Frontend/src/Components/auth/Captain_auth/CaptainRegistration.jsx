            ...
            <div className="w-full md:w-1/2 max-w-md space-y-8 bg-white p-8 rounded-lg shadow-lg">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Join our platform as a captain and start driving!
                    </p>
                </div>
                <form className="mt-8 space-y-6" onSubmit={handleCaptainSignup}>
                    ...
                    <button
                        type="submit"
                        className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                        Register as Captain
                    </button>
                </form>
